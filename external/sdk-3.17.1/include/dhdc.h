...
/* deprecated device identifiers (replaced by the above) */
...
#define DHD_STATUS_FORCE_OFF_CAUSE 14
#define DHD_STATUS_LOCKS           15
#define DHD_STATUS_AXIS_CHECKED    16

/* buttons count */
#define DHD_MAX_BUTTONS            32
...
#define DHD_FORCE_OFF_NONE          0
#define DHD_FORCE_OFF_BUTTON        1
#define DHD_FORCE_OFF_VELOCITY      2
#define DHD_FORCE_OFF_WATCHDOG      3
#define DHD_FORCE_OFF_SOFTWARE      4
#define DHD_FORCE_OFF_USBDISCN      5
#define DHD_FORCE_OFF_DEADMAN       6
 ...
 ****************************************************************************/
  ...
  int         __SDK dhdSetJointTorques                             (double q[DHD_MAX_DOF], uchar mask = 0xff, char ID = -1);
  ...
  int         __SDK dhdSetDeltaJointTorques                        (double q0, double q1, double q2, char ID = -1);
  ...
  int         __SDK dhdSetWristJointTorques                        (double q0, double q1, double q2, char ID = -1);
  int         __SDK dhdSetForceAndWristJointTorques                (double fx, double fy, double fz, double q0, double q1, double q2, char ID = -1);
  int         __SDK dhdSetForceAndWristJointTorquesAndGripperForce (double fx, double fy, double fz, double q0, double q1, double q2, double fg, char ID = -1);
  ...
  int         __SDK dhdJointAnglesToGravityJointTorques            (double j[DHD_MAX_DOF], double q[DHD_MAX_DOF], uchar mask = 0xff, char ID = -1);
